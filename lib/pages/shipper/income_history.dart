...
import '../../pages/shop/calendar.dart';
...
class IncomeHistory extends StatefulWidget {
  ...
  IncomeHistory({Key key, BillingHistoryApi api})
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Column(
          children: <Widget>[
            GradientAppBar(title: allTranslations.text('income_history'), hasBackIcon:true),
            Expanded(
              flex: 1,
              child: Container(
          ...
          onTap: (){
            showModalBottomSheetApp<void>(context: context,
              builder: (BuildContext context) {
                return Container(
                 // child: CreatePackageDetail(hasNavbar: false, order: widget.order,),
                );
              },
